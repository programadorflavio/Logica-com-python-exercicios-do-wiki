...
peso_peixe = float(input('Informe o peso de peixes: '))
excedente = peso_peixe - 50
multa = excedente * 4
print(f'De acordo com o peso informado, o peso excedente de peixe é {excedente} e o valor da multa é R${multa}')